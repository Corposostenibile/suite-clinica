...
function TeamCapacity() {
  ...
  const renderCapacityRow = (row, keyPrefix) => {
    ...
    const tipoSec = row.clienti_tipo_secondario ?? 0;
    ...
    return (
      <tr key={`${keyPrefix}-${row.user_id}`}>
        ...
        <td><span className="tc-badge tc-badge-tipo-sec">{tipoSec}</span></td>
        <td>
      ...
      <table className="tc-table">
        <thead>
          <tr>
            ...
            <th><span className="tc-th-tipo" style={{ color: '#64748b' }}>2nd</span></th>
            <th>Ponderata</th>
            <th>% Capienza</th>
