...
function CheckAzienda() {
  ...
  const tourSteps = useMemo(() => (isTeamLeaderTour ? [
    ...
    { target: '[data-tour="prof-filters"]', title: 'Filtri della Tua Area', content: tourSpecialtyMeta ? `Restringi la vista per professionista della ${specialtyScopeLabel} quando devi isolare una criticita precisa.` : 'Restringi la vista per area o professionista quando devi isolare una criticita precisa.', placement: 'bottom', icon: <i className="ri-group-line" style={{ fontSize: 18, color: '#fff' }} />, iconBg: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
    ...
    { target: '[data-tour="header"]', title: 'Lettura Check della Tua Area', content: tourSpecialtyMeta ? `Questa pagina ti aiuta a leggere la qualita del servizio e capire dove migliorare sui pazienti della tua ${specialtyScopeLabel}.` : 'Questa pagina ti aiuta a leggere la qualita del servizio e capire dove migliorare sui pazienti che segui.', placement: 'bottom', icon: <i className="ri-line-chart-line" style={{ fontSize: 18, color: '#fff' }} />, iconBg: 'linear-gradient(135deg, #22c55e, #16a34a)' },
    { target: '[data-tour="kpi-dashboard"]', title: 'Segnali della Tua Area', content: tourSpecialtyMeta ? `Usa i colori per leggere la priorita nella tua ${specialtyScopeLabel}: verde ok, giallo migliorabile, rosso da trattare subito.` : 'Usa i colori per leggere la priorita sui check: verde ok, giallo migliorabile, rosso da trattare subito.', placement: 'bottom', icon: <i className="ri-information-line" style={{ fontSize: 18, color: '#fff' }} />, iconBg: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    ...
    { target: '[data-tour="prof-filters"]', title: 'Filtri della Tua Area', content: tourSpecialtyMeta ? `La vista e gia focalizzata sulla tua ${specialtyScopeLabel}, cosi puoi isolare in fretta i feedback piu utili.` : 'La vista e gia focalizzata sui check che ti interessano, cosi puoi isolare in fretta i feedback piu utili.', placement: 'bottom', icon: <i className="ri-group-line" style={{ fontSize: 18, color: '#fff' }} />, iconBg: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
