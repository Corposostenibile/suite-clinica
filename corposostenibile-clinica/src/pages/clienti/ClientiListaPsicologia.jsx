...
function ClientiListaPsicologia() {
  ...
  const renderAvatarTeam = (user, role, label) => {
    if (!user) return null;
    const colors = ROLE_COLORS[role] || ROLE_COLORS.p;
  ...
  return (
    <div className="container-fluid p-0">
      {/* Header */}
      <div style={styles.psicoHeader} className="d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
          <h5 className="fw-semibold mb-1 text-white">
            <i className="ri-mental-health-line me-2"></i>Visuale Psicologia
          </h5>
          <small className="opacity-75">Vista ottimizzata per il team psicologia</small>
        </div>
          ...
          <div className="card">
            <div className="card-body py-3">
              <div className="d-flex align-items-center gap-2 mb-2">
                <i className="ri-mental-health-line" style={{ fontSize: '18px', color: '#ec4899' }}></i>
                <span className="fw-semibold text-dark">Stato Psicologia</span>
              </div>
        ...
        <div className="card-body">
          <div className="row gy-3 gx-4 align-items-end">
            ...
            <div className="col-lg-3 col-md-4">
              <label className="form-label fw-semibold text-sm mb-2">Psicologo</label>
              <select
            ...
            <div className="col-lg-2 col-md-3">
              <label className="form-label fw-semibold text-sm mb-2">Stato Psicologia</label>
              <select
                className="form-select"
      ...
      {loading ? (
        <div className="text-center py-5">
          <div className="spinner-border" style={{ width: '3rem', height: '3rem', color: '#ec4899' }}></div>
        ...
        <div className="card">
          <div className="card-body text-center py-5">
            <i className="ri-mental-health-line text-muted" style={{ fontSize: '48px' }}></i>
        ...
        <div className="card">
          <div className="card-header d-flex justify-content-between align-items-center">
            <h5 className="card-title mb-0">
              <i className="ri-mental-health-line me-2" style={{ color: '#ec4899' }}></i>
              ...
              <table className="table table-hover mb-0 align-middle">
                <thead className="table-light">
                  <tr>
                    ...
                    <th>Stato Chat</th>
                    <th>Reach Out</th>
                    <th className="text-center">Patologie</th>
                    <th className="text-center">Comprate</th>
                    <th className="text-center">Svolte</th>
                      ...
                      <tr key={clienteId}>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-1">
                            ...
                            {!cliente.health_manager_user && !cliente.psicologi_multipli?.length &&
                              !cliente.nutrizionisti_multipli?.length && !cliente.coaches_multipli?.length &&
                              !cliente.consulenti_multipli?.length && <em className="text-muted">-</em>}
                          </div>
                        </td>
                        <td>
                          <div className="d-flex align-items-center gap-1">
                            {renderStatoBadge(cliente.stato_psicologia)}
                            <button
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-1">
                            {cliente.stato_cliente_chat_psicologia ? (
                              <span style={{
                                ...styles.statoBadge,
                                background: STATI_PROFESSIONISTA_COLORS[cliente.stato_cliente_chat_psicologia]?.bg || '#f1f5f9',
                                color: STATI_PROFESSIONISTA_COLORS[cliente.stato_cliente_chat_psicologia]?.color || '#64748b'
                              }}>
                        ...
                        <td className="text-center">
                          ...
                          >
                            ...
                            {cliente.storia_psicologia ? 'Vedi' : 'Aggiungi'}
                          </button>
                        </td>
                        <td className="text-center">
                          <button
                            ...
                            style={{
                              ...styles.btnStoria,
                              background: cliente.note_extra_psicologa
                          ...
                          >
                            ...
                            {cliente.note_extra_psicologa ? 'Vedi' : 'Aggiungi'}
                          </button>
                        </td>
                        <td className="text-end">
                          <Link
                            ...
                            className="btn btn-sm"
                            title="Vai a Tab Psicologia"
                            style={{ borderColor: '#ec4899', color: '#ec4899', border: '1px solid' }}
                          >
        ...
        <div className="modal fade show d-block" style={{ background: 'rgba(0,0,0,0.5)' }} tabIndex="-1">
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header" style={{ background: 'linear-gradient(135deg, #ec4899 0%, #db2777 100%)' }}>
              ...
              <div className="modal-body">
                <textarea
                  ...
                  style={{ border: '2px solid rgba(236, 72, 153, 0.2)', borderRadius: '12px' }}
                ></textarea>
              </div>
        ...
        <div className="modal fade show d-block" style={{ background: 'rgba(0,0,0,0.5)' }} tabIndex="-1">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-secondary" onClick={() => setShowSeduteComprateModal(false)}>
                  <i className="ri-close-line me-1"></i> Chiudi
                </button>
                <button
                  type="button"
        ...
        <div className="modal fade show d-block" style={{ background: 'rgba(0,0,0,0.5)' }} tabIndex="-1">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-secondary" onClick={() => setShowSeduteSvolteModal(false)}>
                  <i className="ri-close-line me-1"></i> Chiudi
                </button>
                <button
                  type="button"
        ...
        <div className="modal fade show d-block" style={{ background: 'rgba(0,0,0,0.5)' }} tabIndex="-1">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
                ...
                {getClientPatologie(selectedCliente).length > 0 ? (
                  <div className="d-flex flex-wrap gap-2">
                    {getClientPatologie(selectedCliente).map((p, i) => (
                      <span key={i} style={styles.patologiaTag}>
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-secondary" onClick={() => setShowPatologieModal(false)}>
                  <i className="ri-close-line me-1"></i> Chiudi
                </button>
                <Link
