                ...
                <div className="row g-3 align-items-end">
                    ...
                    <div className="col-lg-2 col-md-3">
                        ...
                        <select
                            ...
                            value={filters.stato_cliente || ''}
                            onChange={(e) => onFilterChange('stato_cliente', e.target.value)}
                        >
                    ...
                    <div className="col-lg-2 col-md-4">
                        ...
                        <select
                            className="form-select"
                            value={filters.nutrizionista_id || ''}
                            onChange={(e) => onFilterChange('nutrizionista_id', e.target.value)}
                        >
                            <option value="">Tutti</option>
                            {nutrizionisti.map(p => (
                    ...
                    <div className="col-lg-2 col-md-4">
                        ...
                        <select
                            ...
                            onChange={(e) => onFilterChange('coach_id', e.target.value)}
                        >
                            <option value="">Tutti</option>
                            {coaches.map(p => (
                                <option key={p.id} value={p.id}>{p.full_name}</option>
                    ...
                    <div className="col-lg-2 col-md-4">
                        ...
                        <select
                            className="form-select"
                            value={filters.psicologa_id || ''}
                            onChange={(e) => onFilterChange('psicologa_id', e.target.value)}
                        >
                            <option value="">Tutti</option>
                            {psicologi.map(p => (
                                <option key={p.id} value={p.id}>{p.full_name}</option>
