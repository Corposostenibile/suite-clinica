    ...
    <div className="login-account">
      <div className="row h-100">
        ...
        <div className="col-lg-6 align-self-start">
          <div className="account-info-area" style={{ background: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)' }}>
            <video className="login-video" autoPlay loop muted playsInline>
              <source src="/login.mp4" type="video/mp4" />
            </video>
            <div className="login-content">
              <p className="sub-title">Gestione aziendale<br />semplice e organizzata</p>
              <h1 className="title">Suite <span>Amministrativa</span></h1>
              <p className="text">Tutti i dati dell'azienda, la gestione amministrativa e finanziaria in un unico posto centralizzato</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
          <div className="login-form">
            ...
            <div className="login-head">
              <h3 className="title">Bentornato!</h3>
