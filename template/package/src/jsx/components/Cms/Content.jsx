                                ...
                                <div className="card-body">
                                    <div className="row filter-row">
                                        ...
                                        <div className="col-xl-3 col-sm-6">
                                            ...
                                            <input type="date" name="datepicker" className=" form-control mb-xl-0 mb-3 bt-datepicker" />                                             
                                        </div>
                                        <div className="col-xl-3 col-sm-6 align-self-end">
                                            <button className="btn btn-primary rounded-sm me-2" title="Click here to Search" type="button"><i className="fa fa-search me-1" />Filter</button>
