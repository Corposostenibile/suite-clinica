								...
								<div className="profile-statistics">
									<div className="text-center">
										...
										<div className="mt-4">
											...
											<Link to={"#"} as="a" className="btn btn-primary mb-1 ms-1" onClick={() => dispatch({type:'sendMessage'})}>Send Message</Link>
										</div>
									</div>
								...
								<div className="profile-interest ">	
									...
									>									
										{galleryBlog.map((item,index)=>(
											<div data-src={item.image} className="col-lg-4 col-xl-4 col-sm-4 col-6 int-col mb-1 p-1 pb-0" key={index}>
								...
								<Tab.Pane id="my-posts"  eventKey='Posts'>
									<div className="my-post-content pt-3">
										<div className="post-input">
											...
											{/* Modal */}
											<Link to={"#"} className="btn btn-primary light px-3 me-1"  onClick={() => dispatch({type:'cameraModal'})}>
										...
										<div className="profile-uoloaded-post border-bottom-1 pb-5">
											...
											<Link className="post-title" to="/post-details">
												<h3 className="text-black">How to Score the Best Seats in the House</h3>
											</Link>
											<p>
										...
										<div className="profile-uoloaded-post border-bottom-1 pb-5">
											...
											<Link className="post-title" to="/post-details">
												<h3 className="text-black">Stories from the World of Events</h3>
											</Link>
											<p>
										...
										<div className="profile-uoloaded-post pb-3">
											<img src={profile08} alt="" className="img-fluid  w-100 rounded" />
											<Link className="post-title" to="/post-details">
												<h3 className="text-black">Navigating the World of Live Entertainment</h3>
											</Link>
											<p>
												A wonderful serenity has take possession of my
												entire soul like these sweet morning of spare which
			  ...
			  <Modal className="modal fade" show={state.sendMessage} onHide={()=>dispatch({type:'sendMessage'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<Button variant="" type="button" className="btn-close"  onClick={() => dispatch({type:'sendMessage'})}>
							{/* <span>×</span> */}
						</Button>
					</div>
			 ...
			 {/* Link Modal */}
			  <Modal show={state.link}  className="modal fade post-input" id="linkModal" onHide={() => dispatch({type:'linkModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-body">
						<Link className="btn-social me-1 facebook mb-1 mb-sm-0" to="/app-profile"><i className="fab fa-facebook-f" /></Link>
						<Link className="btn-social me-1 google-plus mb-1 mb-sm-0" to="/app-profile"> <i className="fab fa-google-plus-g" /></Link>
						<Link className="btn-social me-1 linkedin mb-1 mb-sm-0" to="/app-profile"><i className="fab fa-linkedin-in" /></Link>
						<Link className="btn-social me-1 instagram mb-1 mb-sm-0" to="/app-profile"> <i className="fab fa-instagram" /></Link>
						<Link className="btn-social me-1 twitter mb-1 mb-sm-0" to="/app-profile"><i className="fab fa-twitter" /></Link>
						<Link className="btn-social me-1 youtube mb-1 mb-sm-0" to="/app-profile"><i className="fab fa-youtube" /></Link>
						<Link className="btn-social whatsapp mb-1 mb-sm-0" to="/app-profile"><i className="fab fa-whatsapp" /></Link>
					</div>
				</div>
			</Modal>
			 {/* Camera Modal */}
