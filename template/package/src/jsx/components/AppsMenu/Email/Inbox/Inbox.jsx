                  ...
                  <div className="col-xl-9 col-xxl-8">
                    <div className="email-right-box">
                      <div role="toolbar" className="toolbar d-flex align-items-center">
                        ...
                        {/* <form className="d-none d-sm-block ms-auto">
													<div className="input-group  ms-auto w-100 d-sm-inline-flex d-none">
														<input type="text" className="form-control" placeholder="Search here" />
														<span className="input-group-text"><button className="bg-transparent border-0"><i className="flaticon-381-search-2" /></button></span>
													</div>
												</form> */}
                      </div>
                      {/** Single Message */}
