...
import { IMAGES, WidgetIcon } from '../../constant/theme';
import ActivityTab from '../Dashboard/Elements/ActivityTab';

const cardBlog = [
    {title:"Patient", number:'3280', icon:WidgetIcon.user, percent:'+3.5%', color:"primary"},
    {title:"Bills", number:'2570', icon:WidgetIcon.bills, percent:'+1.5%', color:"warning"},
    {title:"Revenue", number:'364.50K', icon:WidgetIcon.revenue, percent:'-8.5%', color:"danger"},
    {title:"Employe", number:'850', icon:WidgetIcon.grid, percent:'+7.5%', color:"success"},
];
const bgCarddBlog = [
...
const WidgetCard = () => {
    return (
        <>
            <PageTitle motherMenu={"Widget"} activeMenu={"Statistics"}/>  
            <Row>   
