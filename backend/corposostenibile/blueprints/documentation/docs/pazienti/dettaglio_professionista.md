# 📋 Scheda Paziente — Guida Professionista

Per il professionista questa pagina e l'area di lavoro principale sul singolo paziente. La usi prima di una call, durante un follow-up e subito dopo ogni interazione per mantenere continuita e chiarezza.

## Cosa fai qui come Professionista

- Aggiorni diario, piani, setup, note e stato operativo.
- Recuperi velocemente contesto clinico e storico delle decisioni.
- Definisci la prossima azione senza lasciare il paziente in sospeso.

## Cosa aggiornare sempre

- Diario dell'area su cui hai lavorato.
- Stato operativo se qualcosa e cambiato.
- Note di coordinamento e materiali utili al team.
